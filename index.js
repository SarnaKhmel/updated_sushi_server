...
// const deta = Deta("a06uttlgbgn_ZxgMr2wkaJh97Kpxp7fhMPiV6yGV99X2");
...
// //     const fileInfo = await drive.put(req.file.originalname, fileBuffer);
// //     res.json({ url: fileInfo.url });
// //   }
// // );

// // app.delete("/upload/products/:imageName", checkAuth, async (req, res) => {
// //   const imageName = req.params.imageName;
